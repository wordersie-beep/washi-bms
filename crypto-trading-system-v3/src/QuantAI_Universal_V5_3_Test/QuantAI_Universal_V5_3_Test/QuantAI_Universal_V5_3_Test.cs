// =====================================================================================================
//  QuantAI_Universal_V5_3_Test (версия 5.1) — адаптивный AI-cBot для cTrader (API 4.x / cTrader.Automate)
//
//  ИСТОРИЯ ВЕРСИЙ
...
namespace cAlgo.Robots
{
    ...
    internal sealed class BarAnalysis
    {
        ...
        public readonly StrategyVote[] Votes = new StrategyVote[QuantAI_Universal_V5_3_Test.StrategyCount];
    ...
    public class QuantAI_Universal_V5_3_Test : Robot
    {
        ...
        protected override void OnStart()
        {
            ...
            Print("ТЕСТОВАЯ СБОРКА 5.3-TEST: фильтры ослаблены, чтобы сделки открывались часто. Цель — проверить " +
            ...
            _storageKey = StorageKey("QAIv5T " + SymbolName + " " + TimeFrame);
            if (ResetAiMemory)
            {
