# QuantAI_Scalper_M1_MicroDepot_Pro — cBot для cTrader (v1.1.0)
...
[`../tests/QuantAI_Scalper_Tests`](../tests/QuantAI_Scalper_Tests) — 89 проверок логики, не зависящей от брокера
(Naive Bayes, тиковый движок, медиана спреда, симулятор исходов для разметки, детекторы сетапов, деление объёма на TP1):
